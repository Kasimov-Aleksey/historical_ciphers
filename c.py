...
def plot_frequency_distribution(english_frequency, text_frequency):
    ...
    plt.bar(english_frequency.keys(), english_frequency.values(), alpha=0.5, color='b', label='English')
    plt.bar(text_frequency.keys(), text_frequency.values(), alpha=0.5, color='r', label='Text')
    plt.xlabel('Letters')
...
def main():
    ...
    while True:
        ...
        substitution_key = dict(zip(encrypted_alphabet, english_alphabet))
